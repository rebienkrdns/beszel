...
export const alertInfo: Record<string, AlertInfo> = {
	...
	CtxSwitches: {
		name: () => t`Context Switches`,
		unit: "/s",
		icon: RefreshCwIcon,
		desc: () => t`Triggers when context switches per second exceed a threshold`,
		start: 100000,
		min: 1000,
		step: 1000,
	},
	Interrupts: {
		...
		unit: "/s",
		icon: CpuIcon,
		desc: () => t`Triggers when hardware interrupts per second exceed a threshold`,
		start: 50000,
		min: 1000,
		step: 1000,
	},
	...
	ContainerCPU: {
		name: () => t`Container CPU`,
		unit: "%",
		icon: ContainerIcon,
		desc: () => t`Triggers when any container's CPU usage exceeds a threshold`,
	},
	ContainerMem: {
		name: () => t`Container Memory`,
		unit: " MB",
		icon: ContainerIcon,
		desc: () => t`Triggers when any container's memory usage exceeds a threshold`,
		start: 512,
		min: 1,
		step: 64,
		max: 131072,
	...
	ContainerNet: {
		name: () => t`Container Bandwidth`,
		unit: " MB/s",
		icon: ContainerIcon,
		desc: () => t`Triggers when any container's combined network bandwidth exceeds a threshold`,
		start: 10,
		min: 1,
		step: 1,
		max: 250,
	...
	ContainerRestarts: {
		name: () => t`Container Restarts`,
		unit: "",
		icon: ContainerIcon,
		desc: () => t`Triggers when any container restarts within the configured time window`,
		start: 0.5,
		min: 0.5,
		step: 1,
	},
	ContainerOOM: {
		name: () => t`Container OOM Kill`,
		unit: "",
		icon: ContainerIcon,
		desc: () => t`Triggers when the OOM killer terminates a process inside any container (requires cgroup v2)`,
		start: 0.5,
		min: 0.5,
		step: 1,
	},
